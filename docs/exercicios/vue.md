...
## 🧾 Exercício 1
Crie uma lista de tarefas simples em Vue onde:
    1. Renderize uma lista a partir de um array.
    2. Mostre cada item dinamicamente com v-for.
{: .fs-3 }

## 🧾 Exercício 2
Utilizando a ideia de componentes, crie um componente de item
de tarefa que receba as propriedades necessárias e seja que reutilizável.
{: .fs-3 }

## 🧾 Exercício 3

Crie um componente de formulário que permita implementar um CRUD completo de
objetos tarefas, incluindo:
...
Baseie-se no [tutorial](https://www.w3schools.com/vue/vue_scale-up.php) para realizar o exercício 3 novamente, porém, agora no formato de projeto do Vue.
{: .fs-3 }
